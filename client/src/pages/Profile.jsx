...
export default function Profile() {
  ...
  if (!profile) return <p className="text-center text-muted py-16 font-serif">User not found.</p>
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <h2 className="font-display font-bold mb-4 border-t border-border pt-6">Posts</h2>
      {posts.length === 0 ? (
